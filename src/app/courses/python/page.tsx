...
// const lessons = require("../../../lessons/python_lesson.json");
...
//   const editorRef = useRef<any>(null); // Adjust the type according to your PythonEditor component

//   // Add this useEffect to reset lastOutput when lesson changes
//   useEffect(() => {
//     setLastOutput(null);
//   }, [selectedLesson]);
...
//         ...lesson,
//         courseId: 'python' // Add courseId to each lesson
//       }));
...
//       {/* Sidebar Toggle Button - Similar to LeetCode's design */}
//       <button
...
//       {/* Sidebar with better transition and responsive behavior */}
//       <div
...
//                       method: 'POST',
//                       headers: { 'Content-Type': 'application/json' },
//                       body: JSON.stringify({ userId, courseId: 'python' }) // Add courseId
//                     });
...
//                   // On mobile, close sidebar when selecting a lesson
...
//         {/* Collapsed sidebar content - only visible on medium+ screens */}
...
//       {/* Main Content Area - Split Screen with responsive adjustment */}
...
//         {/* Test Section (Right/Bottom Panel) - Responsive layout */}
...
//           if (!error) {
//             // This will be called when Run Code is clicked
...
//           }
//         }}
//         ref={editorRef} // We'll add this ref to access editor methods
//       />
